...
def generate_function_signature_code(function_data: Dict[str, Union[str, List[Dict[str, str]]]]) -> str:
    ...
    function_string += ") -> "
    function_string += (
        f"{convert_c_type_to_python_type(function_data['returnType'])}:\n\t\"\"\"{function_data['description']}\"\"\"\n\t...\n\n"
    )
...
def check_for_functions_that_can_wrap(
    functions_api: List[Union[Any, Dict[str, Union[str, List[Dict[str, str]]]], Dict[str, str]]]
...
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi", "import ctypes\nfrom raypyc.defines import *\nfrom typing import Type\n\n\n"
)

# generate dummy structures code and add dummy structures code to files
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py", generate_dummy_structs_code(["rAudioBuffer", "rAudioProcessor"], for_stub=False)
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi", generate_dummy_structs_code(["rAudioBuffer", "rAudioProcessor"], for_stub=True)
)

# generate structures code add structures code to files
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py",
    generate_structs_aliases_code(config_api_structs, config_api_aliases, for_stub=False),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py", generate_structs_aliases_code(rlgl_api_structs, rlgl_api_aliases, for_stub=False)
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py",
    generate_structs_aliases_code(raylib_api_structs, raylib_api_aliases, for_stub=False),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py",
    generate_structs_aliases_code(raymath_api_structs, raymath_api_aliases, for_stub=False),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py",
    generate_structs_aliases_code(raygui_api_structs, raygui_api_aliases, for_stub=False),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi",
    generate_structs_aliases_code(config_api_structs, config_api_aliases, for_stub=True),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi", generate_structs_aliases_code(rlgl_api_structs, rlgl_api_aliases, for_stub=True)
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi",
    generate_structs_aliases_code(raylib_api_structs, raylib_api_aliases, for_stub=True),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi",
    generate_structs_aliases_code(raymath_api_structs, raymath_api_aliases, for_stub=True),
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi",
    generate_structs_aliases_code(raygui_api_structs, raygui_api_aliases, for_stub=True),
)

# generate structures-dictionary code and add structures-dictionary to files
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.py", generate_structures_dictionary_code(wrapped_structures_names, for_stub=False)
)
add_text_to_file(
    RAYPYC_FOLDER_PATH / "structures/__init__.pyi",
